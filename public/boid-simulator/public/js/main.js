...
//------------------------------------------------------------------------------
function init() {
	//Place in the boid section
	boidSectionOnWebsite = document.getElementById("boid-section");
	container = document.createElement( 'div' );
	boidSectionOnWebsite.appendChild( container );
	...
	container.appendChild( renderer.domElement ); //Could set with tag it should belong t0?
	initComputeRenderer();
	stats = new Stats();
